...
const Auth = (() => {
  ...
  return { init, signInWithGoogle, signInWithEmail, signOut, openAuthModal, submitEmail, openProfileMenu, openJourneyAuthModal, journeyGoogle, submitJourney, startJourneyGuest };
